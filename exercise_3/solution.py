"""Reference solution for Week 1 Exercise 3: The Precision Trap.
...
`0.3`. Comparing two floats with `==` is almost always wrong.

For money or any decimal-precision domain, the correct fix is the
`decimal` module or working in integer cents/satoshis. Rounding is
the quick-fix that's enough for the Week 1 lesson — but the deeper
lesson is "never trust ==  on floats" and the production playbook
is "use Decimal for money".
"""
...
# or integer satoshis; this is the quick-fix for the Week 1 lesson.
if round(wallet, 1) == 0.3:
    print("Transaction Success!")
else:
    print("Transaction failed?")

# WHY the production-grade alternative is worth knowing about even
